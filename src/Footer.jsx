  ...
  return (
    <>
      <div className="footer-container mt-auto">
        <div className="footer-text__section">
          <p className="fs-6">
        ...
        <div className="social-media__logo--container">
        ...
        <div className="contact-info__section">
          <p>Phone: 4051234567</p>
          <p>Mobile: 4059876543</p>
          <p>Email: info@thisisjustatest.com</p>
        </div>
      </div>
    </>
  );
